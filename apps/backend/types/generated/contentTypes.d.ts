...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    sortOrder: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    status: Schema.Attribute.Enumeration<['free', 'premium']> &
...
export interface ApiGameGame extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<['straight', 'nested']> &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'straight'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    grantedPremiumAccess: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    premiumExpiresAt: Schema.Attribute.DateTime;
    premiumGrantedAt: Schema.Attribute.DateTime;
    productDetails: Schema.Attribute.JSON & Schema.Attribute.Required;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    grantsPremiumAccess: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    ...
    premiumDurationMonths: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          min: 1;
        },
    ...
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'board_game'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiQuestionProgressQuestionProgress
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::question-progress.question-progress'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiQuestionQuestion extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    category: Schema.Attribute.Relation<'manyToOne', 'api::category.category'>;
    correctAnswer: Schema.Attribute.Enumeration<
    ...
    > &
      Schema.Attribute.Private;
    option1: Schema.Attribute.String & Schema.Attribute.Required;
    option2: Schema.Attribute.String & Schema.Attribute.Required;
    option3: Schema.Attribute.String & Schema.Attribute.Required;
    option4: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    question: Schema.Attribute.Text & Schema.Attribute.Required;
    sortOrder: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    tags: Schema.Attribute.JSON;
    timesAnswered: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    timesCorrect: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiShopSettingShopSetting extends Struct.SingleTypeSchema {
  ...
  attributes: {
    additionalBoardGamePrice: Schema.Attribute.Decimal &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
        },
    ...
    firstBoardGamePrice: Schema.Attribute.Decimal &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
        },
    ...
    shopEnabled: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    standardShippingCost: Schema.Attribute.Decimal &
      Schema.Attribute.SetMinMax<
        ...
        number
      > &
      Schema.Attribute.DefaultTo<5.99>;
    stripePublishableKey: Schema.Attribute.String;
    stripeSecretKey: Schema.Attribute.Password;
    stripeWebhookSecret: Schema.Attribute.Password;
...
export interface ApiUserMusicUserMusic extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    fileSize: Schema.Attribute.Integer;
    isActive: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    isPremiumUser: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    uploadSlot: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<1>;
    user: Schema.Attribute.Relation<
      'manyToOne',
      'plugin::users-permissions.user'
    > &
...
export interface ApiUserUser extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    email: Schema.Attribute.Email &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    gamesCompleted: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    gameStats: Schema.Attribute.JSON;
    isActive: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    lastGamePlayed: Schema.Attribute.DateTime;
    lastLogin: Schema.Attribute.DateTime;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::question-progress.question-progress': ApiQuestionProgressQuestionProgress;
