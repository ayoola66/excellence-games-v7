      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white rounded-xl shadow-sm p-6">
            ...
            <p className="mt-2 text-3xl font-bold text-yellow-600">{stats.totalSessions}</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-xl shadow-sm p-6">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Game Management</h3>
            <p className="text-gray-600 mb-4">Create and manage trivia games</p>
            <button
          ...
          <div className="bg-white rounded-xl shadow-sm p-6">
            ...
            <p className="text-gray-600 mb-4">Add and edit trivia questions</p>
            <button
