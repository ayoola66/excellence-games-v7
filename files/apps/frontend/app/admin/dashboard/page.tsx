          ...
          <div className="bg-white rounded-2xl shadow-lg p-8">
            ...
            <div className="space-y-4">
              <button
                ...
                className="w-full flex items-center justify-between px-4 py-3 bg-blue-50 text-blue-700 rounded-xl hover:bg-blue-100 transition-colours"
              >
              ...
              <button
                onClick={() => router.push('/admin/games')}
                className="w-full flex items-center justify-between px-4 py-3 bg-green-50 text-green-700 rounded-xl hover:bg-green-100 transition-colours"
              >
                <div className="flex items-centre">
              ...
              <button
                onClick={() => router.push('/admin/games')}
                className="w-full flex items-center justify-between px-4 py-3 bg-yellow-50 text-yellow-700 rounded-xl hover:bg-yellow-100 transition-colours"
              >
                <div className="flex items-centre">
              ...
              <button
                ...
                className="w-full flex items-center justify-between px-4 py-3 bg-purple-50 text-purple-700 rounded-xl hover:bg-purple-100 transition-colours"
              >
                <div className="flex items-centre">
