...
export default function AdminLogin() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (success) {
        compatToast.success('Welcome to Elite Games Admin Panel!')
        router.push('/admin/dashboard')
      }
    } catch (error) {
      compatToast.error('Invalid credentials. Please try again.')
    } finally {
  ...
  const demoCredentials = [
    { label: 'Super Admin', email: 'superadmin@elitegames.com', password: 'Passw0rd', badge: 'SA', color: 'bg-red-500' },
    { label: 'Dev Admin', email: 'devadmin@elitegames.com', password: 'Passw0rd', badge: 'DEV', color: 'bg-black' },
    { label: 'Content Admin', email: 'contentadmin@elitegames.com', password: 'Passw0rd', badge: 'CT', color: 'bg-purple-500' },
    { label: 'Shop Admin', email: 'shopadmin@elitegames.com', password: 'Passw0rd', badge: 'SH', color: 'bg-green-500' },
    { label: 'Customer Admin', email: 'customeradmin@elitegames.com', password: 'Passw0rd', badge: 'CS', color: 'bg-blue-500' }
  ]
