    ...
    <div className="space-y-4">
      ...
      <div className="bg-gray-50 p-4 rounded-md">
        <p className="text-sm text-gray-600 mb-4">
          {gameType === 'linear' ? (
            <>
              Upload a CSV file with questions for this game. The file should have the following columns:<br />
              <code>question,option1,option2,option3,option4,option5,correctAnswer</code>
            </>
          ) : (
            <>
              Upload an XLSX file with 5 sheets (one per category). Each sheet should have the following columns:<br />
              <code>question,option1,option2,option3,option4,option5,correctAnswer</code>
            </>
          )}
        </p>
        ...
        <div className="flex items-center">
          ...
          <label 
            ...
            className="cursor-pointer inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 mr-3"
          >
            Select File
          </label>
      ...
      <div className="text-sm text-gray-500 mt-2">
        ...
        {gameType === 'linear' ? (
          <pre className="bg-gray-100 p-2 rounded-md mt-1 overflow-x-auto">
            question,option1,option2,option3,option4,option5,correctAnswer<br />
            "What is 2+2?","1","2","3","4","5","4"<br />
