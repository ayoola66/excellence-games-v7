...
export default function SettingsPage() {
  ...
  const handleError = (error: any, message: string) => {
    ...
    compatToast.error(error.message || message)
  }
  ...
  const handleMusicUpload = async (file: File) => {
    ...
    if (file.size > 2 * 1024 * 1024) {
      compatToast.error('File size must be less than 2MB')
      return
    }
    ...
    try {
      ...
      compatToast.success('Music track uploaded successfully')
    } catch (error: any) {
  ...
  const handleVolumeChange = async (volume: number) => {
    ...
    try {
      ...
      compatToast.success('Volume updated successfully')
    } catch (error: any) {
  ...
  const handleMusicToggle = async (enabled: boolean) => {
    ...
    try {
      ...
      compatToast.success('Music settings updated successfully')
    } catch (error: any) {
  ...
  const handleBillingSubmit = async (formData: FormData) => {
    ...
    try {
      ...
      compatToast.success('Billing information updated successfully')
    } catch (error: any) {
            ...
            >
              ...
              {activeTab === 'billing' && (
                <div className="space-y-6">
                  ...
                  <form onSubmit={(e) => {
                    e.preventDefault()
                    handleBillingSubmit(new FormData(e.currentTarget))
                  }} className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        <label htmlFor="name" className="block text-sm font-medium text-blue-700 mb-2">Full Name</label>
                        <input
                          type="text"
                          id="name"
                          name="name"
                      ...
                      <div>
                        <label htmlFor="address" className="block text-sm font-medium text-blue-700 mb-2">Address</label>
                        <input
                          type="text"
                          id="address"
                          name="address"
                      ...
                      <div>
                        <label htmlFor="city" className="block text-sm font-medium text-blue-700 mb-2">City</label>
                        <input
                          type="text"
                          id="city"
                          name="city"
                      ...
                      <div>
                        <label htmlFor="country" className="block text-sm font-medium text-blue-700 mb-2">Country</label>
                        <input
                          type="text"
                          id="country"
                          name="country"
                      ...
                      <div>
                        <label htmlFor="postcode" className="block text-sm font-medium text-blue-700 mb-2">Postcode</label>
                        <input
                          type="text"
                          id="postcode"
                          name="postcode"
              ...
              {activeTab === 'preferences' && (
                <div className="space-y-6">
                  <h2 className="text-2xl font-bold text-blue-900 mb-6">Game Preferences</h2>
                  {/* Add game preferences settings here */}
                </div>
              )}
