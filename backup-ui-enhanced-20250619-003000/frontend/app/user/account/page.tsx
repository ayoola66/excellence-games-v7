...
export default function UserAccount() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.fullName || !formData.email) {
      compatToast.error('Please fill in all required fields')
      return
    }

    if (formData.newPassword && formData.newPassword !== formData.confirmPassword) {
      compatToast.error('New passwords do not match')
      return
    }
    ...
    try {
      ...
      setUser(data.user)
      compatToast.success('Profile updated successfully')
      ...
      compatToast.error(error.message || 'Failed to update profile')
    } finally {
      setIsLoading(false)
    }
  }
